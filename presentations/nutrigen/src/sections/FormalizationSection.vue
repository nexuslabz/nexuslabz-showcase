...
const items = [
  ...
  },
  {
    ...
    desc: 'Toda a plataforma será desenvolvida, hospedada e mantida pela Nexus Labz, garantindo suporte contínuo, evolução técnica e estabilidade a longo prazo.',
  },
  {
    icon: '🤝',
