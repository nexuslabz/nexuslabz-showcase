...
const plans = [
  {
    ...
    features: [
      ...
      'Suporte de segunda a sexta, das 10h às 19h',
  ...
  },
  {
    ...
    tier: 'grey',
    features: [
      'Inclui tudo do White',
      'Otimizações de performance',
      'Relatórios mensais de métricas',
      'Ajustes contínuos para Google e IAs',
  ...
  },
  {
    ...
    features: [
      ...
      'Pequenas melhorias no produto ao longo do mês',
      'Backup semanal e monitoramento ativo',
    ],
  },
];
</script>
