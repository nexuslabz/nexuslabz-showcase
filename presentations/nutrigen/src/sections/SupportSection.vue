  ...
  <section class="support">
    <div class="support__content">
      ...
      <p class="support__desc">
        Seu pacote já inclui 6 meses de suporte <span class="text-gold">Nexus Gold</span>. Depois
        disso, você pode optar por um dos planos abaixo para manter o site evoluindo.
      </p>
