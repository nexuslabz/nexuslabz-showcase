...
import CurrentBrandSection from './sections/CurrentBrandSection.vue';
import PaletteSection from './sections/PaletteSection.vue';
import Model01Section from './sections/Model01Section.vue';
import Model02Section from './sections/Model02Section.vue';
import Model03Section from './sections/Model03Section.vue';
import Model04Section from './sections/Model04Section.vue';
...
.nav-progress-fill {
  height: 100%;
  background: linear-gradient(90deg, var(--neon-gold-dim), var(--neon-gold));
  border-radius: 2px;
